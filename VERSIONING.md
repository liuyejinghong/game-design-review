...
新增可选视角 R09，既有 R01–R08 的编号、含义和十节报告不变；按编排插在 R06/R07 前，不按编号自动排序。路线决策使用 R09-Axx 存轮次报告，并入第 8/9 节，不属于 P0/P1/P2。
报告和媒体量表语义不变，report_schema 与 critic_scale 仍为 1。新增触发、覆盖与模板须整包更新；旧 run 不补写成已执行 R09，使用旧证据时标新尺复评。
